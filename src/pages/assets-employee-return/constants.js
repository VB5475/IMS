...
export const AER_CONFIG = {
  ...
  // Select Item modal — no Main/Sub Group or Item Name filters; items load
  // directly from SP_ITEM_PICKER using buildAerItemPickerJsonPayload(headerValues).
...
// AssetsEmployeeReturn.rpt takes no per-record filter — the listing page's
// Print button (and the form's Save & Print) always run this company-wide report.
export function buildAerReportParams() {

...
export default function AssetsRevaluationForm() {
  ...
  const groupFilter = useItemPickerGroupFilter({
    spMainGroup: ARV_CONFIG.SP_ITEM_MAIN_GROUP,
    spSubMainGroup: ARV_CONFIG.SP_ITEM_SUB_MAIN_GROUP,
    formTag: ARV_CONFIG.FORM_TAG,
  });
  ...
  return (
    <div className="workspace-page workspace-page--fill arv-page">
      ...
      <section className="arv-grid-section" ref={itemGridSectionRef}>
        <EntryGrid
          ref={itemGridRef}

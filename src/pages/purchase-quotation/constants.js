...
export const QTN_LIST_DROPDOWN_FIELDS = new Set([
  'DivisionID',
  'ConfigID',
  'DeptID',
  'SupplierID',
...
export const QTN_HEADER_FILTERS = [
  ...
  { FilterParameterID: 'BasedOnID', FilterColCtrlType: controlTypeMap.DROPDOWN, staticOptions: QTN_CONFIG.BASED_ON_OPTIONS },
